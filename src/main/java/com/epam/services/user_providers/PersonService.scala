...
@Component
case class PersonService(@Value("${personsFilepath}") private val personsFilepath: String, private val personValidator: PersonValidator, private val reader: TextFileReader)
